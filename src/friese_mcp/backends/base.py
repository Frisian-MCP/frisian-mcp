"""
Abstract base classes and core dataclasses for the friese-mcp backend layer.
...
:class:`~friese_mcp.backends.invocation.SyncInvocation` are used.
"""
...
class ToolDefinition:  # pylint: disable=too-many-instance-attributes
    ...
    :class:`~friese_mcp.registry.ToolRegistry`.
...
class BaseInvocationBackend(ABC):
    ...
    def invoke(
        ...
        :class:`~friese_mcp.registry.ToolRegistry` before this method is
        called.
