"""
DRF permission classes for frisian_mcp.contrib.tokens.
...
class IsAuthenticatedOrServiceToken(BasePermission):
    ...
    2. ``request.auth`` is a :class:`~frisian_mcp.contrib.tokens.models.FrisianMcpToken`
    ...
    def has_permission(self, request: Any, view: Any) -> bool:
        ...
        return isinstance(auth, FrisianMcpToken) and auth.is_active
