...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "MCP endpoint URL. Defaults to FRISIAN_MCP_BASE_URL setting "
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "Defaults to FRISIAN_MCP_SERVER_NAME setting or 'frisian-mcp'."
            ),
        )
    ...
    def handle(self, *args: object, **options: object) -> None:
        ...
        server_name: str = (
            str(options["name"])
            if options.get("name")
            else getattr(settings, "FRISIAN_MCP_SERVER_NAME", "frisian-mcp")
        )
        url: str = (
            str(options["url"])
            if options.get("url")
            else getattr(settings, "FRISIAN_MCP_BASE_URL", _DEFAULT_URL)
        )
